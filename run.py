...
from utils.select_option import select_callback
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", type=int, default=220902, help="seed to use")
    ...
    # import shlex
    # #argString = '-e scenes_yuval -sb ../results -d "/media/dense/My Book/neural_sparse_big_folder/neural-scene-graphs/data/kitti/training/image_02" -r 1'
    # argString = '--ginc configs/infonerf/tnt.gin --scene_name toy  --ginb run.run_train=False'
    ...
    if "CURRENT_RANK_DATALOADER" not in os.environ :
        os.environ["CURRENT_RANK_DATALOADER"] = "1"
