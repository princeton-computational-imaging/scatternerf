...
from src.data.data_util.dense import load_dense_data
from src.data.data_util.dense_raw import load_dense_raw_data
...
class LitDataDense(LitData):
    def __init__(
        ...
        super(LitDataDense, self).__init__(datadir)

@gin.configurable(denylist=["datadir", "scene_name"])
class LitDataDenseRaw(LitData):
    def __init__(
        self,
        datadir: str,
        scene_name: str,
        ...
        print('Loaded dense raw', scene_name, self.images.shape, self.render_poses.shape, self.intrinsics[0],
              len(self.i_train), len(self.i_val), len(self.i_test), len(self.i_all))
        super(LitDataDenseRaw, self).__init__(datadir)
